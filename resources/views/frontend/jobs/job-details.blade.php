                ...
                <nav aria-label="breadcrumb" class="rounded-3 p-3">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item">
                            <a href="{{ route('findAllJobs') }}" style="color: rgb(53, 169, 169)">
                            ...
                            <div class="jobs_right">
                                <div class="apply_now">
                                    <a href="javascript:void(0)" onclick="saveJob({{ $job->id }})">
                                        <i class="fa fa-heart-o" style="color:rgb(53, 169, 169)" aria-hidden="true"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="job_sumary">
                        ...
                        <div class="job_content pt-3">
                            <ul>
                                ...
                                <li>Location: <span>{{ $job->main_branch }}</span></li>
